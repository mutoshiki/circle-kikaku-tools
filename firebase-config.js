...
(function loadApplicantSyncFeature() {
  function load() {
    ...
    if (!document.querySelector('link[data-sanpo-participant-announcement]')) {
      const stylesheet = document.createElement('link');
      stylesheet.rel = 'stylesheet';
      stylesheet.href = './assets/css/guides-modals/import-guide/08-participant-announcement.css?v=participant-announcement-ux-v97';
    ...
    if (!document.querySelector('script[data-sanpo-participant-announcement]')) {
      const script = document.createElement('script');
      script.src = './assets/js/features/participant-announcement.js?v=participant-announcement-ux-v97';
