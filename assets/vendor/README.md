...
- Carbon Web Components 2.60.0とCarbon Icons 11.85.0は、UI Shellを含む`assets/js/carbon-entry.js`を`npm run build:carbon`で単一bundleし、`carbon/carbon-entry.min.js`へ生成する。
