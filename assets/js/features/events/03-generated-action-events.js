...
(function (global) {
    ...
    function setupGeneratedHtmlEventDelegation() {
        ...
        const generatedActionHandlers = {
            ...
            'settlement-settings-next': () => global.nextSettlementSettingsStep?.(),
            'settlement-settings-back': () => global.previousSettlementSettingsStep?.(),
            'settlement-settings-go-step': ({ target }) => global.goToSettlementSettingsStep?.(target?.dataset?.step),
