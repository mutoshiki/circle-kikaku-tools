...
function resetSheetViewport() {
    ...
    fitInitialSheetScale({ fitAll: true });
    byId('sheet-view-area')?.focus?.({ preventScroll: true });
}
...
D.addEventListener('DOMContentLoaded', () => {
    ...
    byId('sheet-fit-btn')?.addEventListener('click', event => {
...
window.resetSheetViewport = resetSheetViewport;
