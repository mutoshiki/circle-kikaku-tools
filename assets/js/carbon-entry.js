...
import Clean20 from '@carbon/icons/es/clean/20.js';
...
import Flag20 from '@carbon/icons/es/flag/20.js';
import GenderFemale20 from '@carbon/icons/es/gender--female/20.js';
import GenderMale20 from '@carbon/icons/es/gender--male/20.js';
...
import Map20 from '@carbon/icons/es/map/20.js';
import Menu20 from '@carbon/icons/es/menu/20.js';
import Moon20 from '@carbon/icons/es/moon/20.js';
import Notebook20 from '@carbon/icons/es/notebook/20.js';
import Number120 from '@carbon/icons/es/number--1/20.js';
import Number220 from '@carbon/icons/es/number--2/20.js';
import Number320 from '@carbon/icons/es/number--3/20.js';
import Number420 from '@carbon/icons/es/number--4/20.js';
import OverflowMenuHorizontal20 from '@carbon/icons/es/overflow-menu--horizontal/20.js';
import OverflowMenuVertical20 from '@carbon/icons/es/overflow-menu--vertical/20.js';
import PaintBrushAlt20 from '@carbon/icons/es/paint-brush--alt/20.js';
...
import Undo20 from '@carbon/icons/es/undo/20.js';
import Unlocked20 from '@carbon/icons/es/unlocked/20.js';
import UserFollow20 from '@carbon/icons/es/user--follow/20.js';
import UserMultiple32 from '@carbon/icons/es/user--multiple/32.js';
import Wallet20 from '@carbon/icons/es/wallet/20.js';
...
const ICONS = Object.freeze({
  ...
  'checkmark--filled': CheckmarkFilled20,
  'chevron--down': ChevronDown20,
  'chevron--up': ChevronUp20,
  'circle--filled': CircleFilled20,
  clean: Clean20,
  close: Close20,
  ...
  flag: Flag20,
  'gender--female': GenderFemale20,
  'gender--male': GenderMale20,
  help: Help20,
  idea: Idea20,
  ...
  'overflow-menu-vertical': OverflowMenuVertical20,
  'paint-brush--alt': PaintBrushAlt20,
  ...
  undo: Undo20,
  unlocked: Unlocked20,
  'user--follow': UserFollow20,
  'user-multiple': UserMultiple32,
  wallet: Wallet20,
  'warning--alt': WarningAlt20
});
