...
assert(css.includes('.allocation-mode-toggle cds-content-switcher.car-plan-template-tabs'), 'car/team toggle should use the official Carbon Content Switcher host');
