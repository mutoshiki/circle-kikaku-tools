...
assert.match(participantUi, /list\.setAttribute\('aria-label', managed \? '当選者を選択'/);
...
console.log('PASS participants Carbon confirmed-flow UI, direct applicant sync, organizer handoff export, and participant announcement contract');
