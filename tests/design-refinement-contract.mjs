...
expect(people.includes('<span class="capacity-badge capacity-display"') && people.includes('class="capacity-count"') && !people.includes('capacity-edit-btn capacity-edit-pill'), 'Capacity must be read-only in the card header and edited from the group menu.');
