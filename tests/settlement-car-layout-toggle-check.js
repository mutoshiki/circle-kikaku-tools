...
assert(cardCss.includes('--amount-font-size: var(--settlement-car-amount-size);') && cardCss.includes('--settlement-car-amount-size: 1.05rem;') && cardCss.includes('--settlement-car-amount-size: 0.96rem;') && cardCss.includes('--settlement-car-amount-size: 0.84rem;'), 'payment amounts must use the enlarged responsive typography scale');
