...
assert.match(menu, /pendingPersonMenuActivation/, 'deferred synthetic-click fallback state is missing');
assert.match(menu, /openCompactPersonMenu\(trigger\)/, 'touch fallback does not explicitly open the Carbon overflow menu');
