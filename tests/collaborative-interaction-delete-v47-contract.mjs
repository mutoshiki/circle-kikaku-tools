...
for (const path of [
  ...
  assert.match(tail, /collab-interaction-delete-v47|settlement-concurrent-save-v48|settlement-concurrent-save-v49|collaborative-sync-foundation-v50/, `${path} is cache-busted as a compatible collaborative build`);
}
