...
for (const path of [
  ...
  assert.match(tail, /collab-interaction-delete-v47|settlement-concurrent-save-v48|settlement-concurrent-save-v49|collaborative-sync-foundation-v50|settlement-negative-extra-save-v51|collection-carbon-v65|settlement-extra-concurrent-v66|sync-reliability-v67|sync-protocol-v68|mobile-fix-v71/, `${path} is cache-busted as a compatible collaborative build`);
}
