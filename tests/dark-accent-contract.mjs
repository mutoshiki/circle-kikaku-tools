...
expect(index.includes('usability-v33'), 'Dark theme cache-buster was not updated.');
expect(index.includes('usability-v33'), 'Popup owner cache-busters were not updated.');
