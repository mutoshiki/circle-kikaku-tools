...
expect(index.includes('person-menu-touch-v35'), 'Dark theme cache-buster was not updated.');
expect(index.includes('person-menu-touch-v35'), 'Popup owner cache-busters were not updated.');
