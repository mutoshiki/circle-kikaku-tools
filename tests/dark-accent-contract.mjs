...
expect(index.includes('ui-fixes-v34'), 'Dark theme cache-buster was not updated.');
expect(index.includes('ui-fixes-v34'), 'Popup owner cache-busters were not updated.');
