...
assert(css.includes('--settlement-tag-min-width: 2.4em') && css.includes('border-radius: var(--radius-xs)'), 'split/club labels should use the shared Carbon tag geometry');
