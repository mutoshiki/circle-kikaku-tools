...
assert(css.includes('--settlement-car-amount-col: minmax(82px, 0.72fr);') && css.includes('--settlement-car-amount-col: 68px;') && css.includes('--settlement-car-amount-col: 60px;'), 'driver payment cards should reserve enlarged responsive amount columns while keeping badges aligned near four-digit amounts');
