...
assert(css.includes('--settlement-car-amount-col: 61px;'), 'compact two-column cards should use a font-independent amount width so badges stay vertically aligned');
