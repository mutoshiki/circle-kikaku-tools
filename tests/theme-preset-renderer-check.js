...
assert(html.includes('theme-choice-columns'), 'separated light/dark theme columns are missing');
...
assert(js.includes('defaultByScope'), 'theme registry should expose separate defaults by scope');
...
assert(lightCards.length === 4, 'light preset count should be standard plus 3 added themes');
assert(darkCards.length === 4, 'dark preset count should be standard plus 3 added themes');
...
assert(lightCards.includes('standard') && lightCards.includes('spinel-light') && lightCards.includes('strawberry-matcha') && lightCards.includes('earthbound-cave'), 'light theme set is incomplete');
assert(darkCards.includes('standard') && darkCards.includes('github-dark') && darkCards.includes('night-owl-black') && darkCards.includes('synthwave-84'), 'dark theme set is incomplete');
